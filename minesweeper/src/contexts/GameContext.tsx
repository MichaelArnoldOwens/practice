...
import { buildBoard, copyVisibleBoard, getNextCellType, pickRandomMines } from "@/utils/board_utils";
import { ReactNode, useState, createContext, useMemo, useCallback } from "react";
...
const GameContext = createContext<GameContextType>({ visibleBoard: [], mineSet: new Set(), updateVisibleBoard: () => { } })
...
export const GameContextProvider = ({ children, difficulty }: GameContextProviderProps) => {
  ...
  const updateVisibleBoard = useCallback((cell: CellIndex) => {
